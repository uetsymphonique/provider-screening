"""Staging primitives shared by html_to_text.py (and, historically, its now-
retired sibling scripts). Deliberately dependency-free (stdlib only) and
generic enough that pdf_to_text.py could adopt it later -- not done now,
scope of this refactor is HTML only.
"""
