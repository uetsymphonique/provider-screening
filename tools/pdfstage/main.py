...
Usage:
  python tools/pdfstage/main.py <url-or-path> --product <product_id> [--domain bsg]
  python tools/pdfstage/main.py <url-or-path> [--out-dir <dir>] [--slug <name>]
                                               [--preview <N>]
...
def download(url: str, dest: Path) -> None:
    ...
    req = urllib.request.Request(
        url,
        headers={
            "User-Agent": "Mozilla/5.0 (provider-screening tools/pdfstage/main.py)",
