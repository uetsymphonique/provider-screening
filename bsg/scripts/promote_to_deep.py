...
Scans every `bsg/runs/<product_id>/assessment.json` where
...
Run the validator on every assessment first (or via run_batch.py),
...
RUNS_ROOT = REPO_ROOT / "bsg" / "runs"
DEFAULT_OUT = REPO_ROOT / "bsg" / "decisions"
SCRIPTS_DIR = REPO_ROOT / "bsg" / "scripts"
